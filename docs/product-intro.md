...
ACP Claw — 一个永不停歇的 AI 编程助手。它在飞书里长驻运行，通过 ACP 协议接入任何 AI Agent（Coco、Codex、Claude Code、Gemini...），让你随时随地用飞书消息驱动 AI 写代码、执行命令、读写文件。
</callout>
...
| Agent | 命令 | 特点 |
|-------|------|------|
| **Coco** | `coco acp serve` | 字节内部 Agent，深度工具集成 |
